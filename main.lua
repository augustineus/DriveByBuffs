...
add options table; https://wowpedia.fandom.com/wiki/Using_the_Interface_Options_Addons_panel
 ...
 function DriveByBuffs:GetMessage(info)
	 return self.db.profile.message
 end
 
 function DriveByBuffs:SetMessage(info, value)
	 self.db.profile.message = value
 end
 
 function DriveByBuffs:IsShowOnScreen(info)
 ...
 function DriveByBuffs:ToggleShowOnScreen(info, value)
